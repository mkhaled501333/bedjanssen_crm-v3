...
-- - call_categories, cities, governorates, customer_phones
-- - ticket_items, customercall, product_info, request_reasons
-- - ticket_categories, ticket_item_maintenance, ticketcall
-- =====================================================
...
-- 7. This file contains triggers for existing tables only (removed non-existent table triggers)
-- =====================================================