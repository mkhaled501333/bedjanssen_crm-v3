...
Future<void> insertEntitiesData(MySqlConnection conn) async {
  ...
  final entities = [
    ...
    {'id': 9, 'name': 'call_types'},
    {'id': 10, 'name': 'cities'},
    {'id': 11, 'name': 'governorates'},
    {'id': 12, 'name': 'product_info'},
    {'id': 13, 'name': 'request_reasons'},
    {'id': 14, 'name': 'ticket_categories'},
    {'id': 15, 'name': 'companies'},
    {'id': 16, 'name': 'roles'},
    {'id': 17, 'name': 'permissions'},
    {'id': 18, 'name': 'ticket_item_change_same'},
    {'id': 19, 'name': 'ticket_item_change_another'},
    {'id': 20, 'name': 'ticket_item_maintenance'},
  ];
